...
double Tm = -12;            // Temperatura do ambiente
double T0 = 21;             // Temperatura inicial do corpo
double k = 0.15;            // Constante de resfriamento do material
double C = 0;               // Constante da formula = diferença entre TEmperatura inicial e do ambiente
//==========================================================
int n = 0;

//Solucao Analítica do problema de Resfriamento de Newton
double solucao(){
...
int main()
{
    ...
    C = T0 - Tm;     // Constante da formula = diferença entre temperatura inicial e do ambiente
